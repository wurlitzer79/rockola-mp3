...
async function fetchThumbnails(collectionId) {
  ...
  try {
	...
	async function generateMenu() {
		...
		,{ id: "08-all-you-zombies-album-version",															name: "80's Rock<br>The Essential" }
		...
		,{ id: "kiss-20th-century-masters-the-millennium-collection",										name: "Kiss The Best Of<br>20th Century Masters" }
